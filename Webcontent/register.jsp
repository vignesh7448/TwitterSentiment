...
<html lang="en">
    <head>
        ...
        function passValid(p,cp) {
			
        	var pv = document.getElementById(p).value;
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="login_form_inner reg_form">
							...
							<form class="row login_form" action="RegisterServlet" method="post" id="contactForm" >
								...
								<div class="col-md-12 form-group">
									<input type="password" class="form-control" id="pass" name="pass" placeholder="Confirm password" onchange="passValid('password','pass')" required="required">
								</div>
								<div class="col-md-12 form-group">
